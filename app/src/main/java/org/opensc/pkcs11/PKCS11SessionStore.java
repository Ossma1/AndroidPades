...
public class PKCS11SessionStore implements LoadStoreParameter
{
    ...
    /**
     * Closes the session of a successful call to {@link LoadStoreParameter} 
     ...
     * {@link LoadStoreParameter}  did not contain a
     ...
     * {@link LoadStoreParameter}  did not contain a SO
     * ProtectionParameter.
     * 
     ...
     *         {@link LoadStoreParameter}  opened a session.
     */
