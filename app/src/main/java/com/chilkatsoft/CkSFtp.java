...
public class CkSFtp {
  ...
  public CkTask GetFileSize32Async(String pathOrHandle, boolean bFollowLinks, boolean bIsHandle) {
    long cPtr = chilkatJNI.CkSFtp_GetFileSize32Async(swigCPtr, this, pathOrHandle, bFollowLinks, bIsHandle);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask GetFileSize64Async(String pathOrHandle, boolean bFollowLinks, boolean bIsHandle) {
    long cPtr = chilkatJNI.CkSFtp_GetFileSize64Async(swigCPtr, this, pathOrHandle, bFollowLinks, bIsHandle);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask GetFileSizeStrAsync(String pathOrHandle, boolean bFollowLinks, boolean bIsHandle) {
    long cPtr = chilkatJNI.CkSFtp_GetFileSizeStrAsync(swigCPtr, this, pathOrHandle, bFollowLinks, bIsHandle);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask ReadFileBytes32Async(String handle, int offset, int numBytes) {
    long cPtr = chilkatJNI.CkSFtp_ReadFileBytes32Async(swigCPtr, this, handle, offset, numBytes);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask ReadFileBytes64Async(String handle, long offset, int numBytes) {
    long cPtr = chilkatJNI.CkSFtp_ReadFileBytes64Async(swigCPtr, this, handle, offset, numBytes);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask ReadFileBytes64sAsync(String handle, String offset, int numBytes) {
    long cPtr = chilkatJNI.CkSFtp_ReadFileBytes64sAsync(swigCPtr, this, handle, offset, numBytes);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask ReadFileText32Async(String handle, int offset, int numBytes, String charset) {
    long cPtr = chilkatJNI.CkSFtp_ReadFileText32Async(swigCPtr, this, handle, offset, numBytes, charset);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask ReadFileText64Async(String handle, long offset, int numBytes, String charset) {
    long cPtr = chilkatJNI.CkSFtp_ReadFileText64Async(swigCPtr, this, handle, offset, numBytes, charset);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask ReadFileText64sAsync(String handle, String offset, int numBytes, String charset) {
    long cPtr = chilkatJNI.CkSFtp_ReadFileText64sAsync(swigCPtr, this, handle, offset, numBytes, charset);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask WriteFileBytes32Async(String handle, int offset, CkByteData data) {
    long cPtr = chilkatJNI.CkSFtp_WriteFileBytes32Async(swigCPtr, this, handle, offset, CkByteData.getCPtr(data), data);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask WriteFileBytes64Async(String handle, long offset64, CkByteData data) {
    long cPtr = chilkatJNI.CkSFtp_WriteFileBytes64Async(swigCPtr, this, handle, offset64, CkByteData.getCPtr(data), data);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask WriteFileBytes64sAsync(String handle, String offset64, CkByteData data) {
    long cPtr = chilkatJNI.CkSFtp_WriteFileBytes64sAsync(swigCPtr, this, handle, offset64, CkByteData.getCPtr(data), data);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask WriteFileText32Async(String handle, int offset32, String charset, String textData) {
    long cPtr = chilkatJNI.CkSFtp_WriteFileText32Async(swigCPtr, this, handle, offset32, charset, textData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask WriteFileText64Async(String handle, long offset64, String charset, String textData) {
    long cPtr = chilkatJNI.CkSFtp_WriteFileText64Async(swigCPtr, this, handle, offset64, charset, textData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask WriteFileText64sAsync(String handle, String offset64, String charset, String textData) {
    long cPtr = chilkatJNI.CkSFtp_WriteFileText64sAsync(swigCPtr, this, handle, offset64, charset, textData);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
