...
public class CkZip {
  ...
  public void get_AutoRun(CkString str) {
    chilkatJNI.CkZip_get_AutoRun(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String autoRun() {
    return chilkatJNI.CkZip_autoRun(swigCPtr, this);
  }

  public void put_AutoRun(String newVal) {
    chilkatJNI.CkZip_put_AutoRun(swigCPtr, this, newVal);
  }

  public void get_AutoRunParams(CkString str) {
    chilkatJNI.CkZip_get_AutoRunParams(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String autoRunParams() {
    return chilkatJNI.CkZip_autoRunParams(swigCPtr, this);
  }

  public void put_AutoRunParams(String newVal) {
    chilkatJNI.CkZip_put_AutoRunParams(swigCPtr, this, newVal);
  }

  public boolean get_AutoTemp() {
    return chilkatJNI.CkZip_get_AutoTemp(swigCPtr, this);
  }

  public void put_AutoTemp(boolean newVal) {
    chilkatJNI.CkZip_put_AutoTemp(swigCPtr, this, newVal);
  }
  ...
  public void get_ExeDefaultDir(CkString str) {
    chilkatJNI.CkZip_get_ExeDefaultDir(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String exeDefaultDir() {
    return chilkatJNI.CkZip_exeDefaultDir(swigCPtr, this);
  }

  public void put_ExeDefaultDir(String newVal) {
    chilkatJNI.CkZip_put_ExeDefaultDir(swigCPtr, this, newVal);
  }

  public boolean get_ExeFinishNotifier() {
    return chilkatJNI.CkZip_get_ExeFinishNotifier(swigCPtr, this);
  }

  public void put_ExeFinishNotifier(boolean newVal) {
    chilkatJNI.CkZip_put_ExeFinishNotifier(swigCPtr, this, newVal);
  }

  public void get_ExeIconFile(CkString str) {
    chilkatJNI.CkZip_get_ExeIconFile(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String exeIconFile() {
    return chilkatJNI.CkZip_exeIconFile(swigCPtr, this);
  }

  public void put_ExeIconFile(String newVal) {
    chilkatJNI.CkZip_put_ExeIconFile(swigCPtr, this, newVal);
  }

  public boolean get_ExeNoInterface() {
    return chilkatJNI.CkZip_get_ExeNoInterface(swigCPtr, this);
  }

  public void put_ExeNoInterface(boolean newVal) {
    chilkatJNI.CkZip_put_ExeNoInterface(swigCPtr, this, newVal);
  }

  public boolean get_ExeSilentProgress() {
    return chilkatJNI.CkZip_get_ExeSilentProgress(swigCPtr, this);
  }

  public void put_ExeSilentProgress(boolean newVal) {
    chilkatJNI.CkZip_put_ExeSilentProgress(swigCPtr, this, newVal);
  }

  public void get_ExeTitle(CkString str) {
    chilkatJNI.CkZip_get_ExeTitle(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String exeTitle() {
    return chilkatJNI.CkZip_exeTitle(swigCPtr, this);
  }

  public void put_ExeTitle(String newVal) {
    chilkatJNI.CkZip_put_ExeTitle(swigCPtr, this, newVal);
  }

  public void get_ExeUnzipCaption(CkString str) {
    chilkatJNI.CkZip_get_ExeUnzipCaption(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String exeUnzipCaption() {
    return chilkatJNI.CkZip_exeUnzipCaption(swigCPtr, this);
  }

  public void put_ExeUnzipCaption(String newVal) {
    chilkatJNI.CkZip_put_ExeUnzipCaption(swigCPtr, this, newVal);
  }

  public void get_ExeUnzipDir(CkString str) {
    chilkatJNI.CkZip_get_ExeUnzipDir(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String exeUnzipDir() {
    return chilkatJNI.CkZip_exeUnzipDir(swigCPtr, this);
  }

  public void put_ExeUnzipDir(String newVal) {
    chilkatJNI.CkZip_put_ExeUnzipDir(swigCPtr, this, newVal);
  }

  public boolean get_ExeWaitForSetup() {
    return chilkatJNI.CkZip_get_ExeWaitForSetup(swigCPtr, this);
  }

  public void put_ExeWaitForSetup(boolean newVal) {
    chilkatJNI.CkZip_put_ExeWaitForSetup(swigCPtr, this, newVal);
  }

  public void get_ExeXmlConfig(CkString str) {
    chilkatJNI.CkZip_get_ExeXmlConfig(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String exeXmlConfig() {
    return chilkatJNI.CkZip_exeXmlConfig(swigCPtr, this);
  }

  public void put_ExeXmlConfig(String newVal) {
    chilkatJNI.CkZip_put_ExeXmlConfig(swigCPtr, this, newVal);
  }
  ...
  public long get_MaxUncompressSize() {
    return chilkatJNI.CkZip_get_MaxUncompressSize(swigCPtr, this);
  }

  public void put_MaxUncompressSize(long newVal) {
    chilkatJNI.CkZip_put_MaxUncompressSize(swigCPtr, this, newVal);
  }
  ...
  public boolean AddEmbedded(String exeFilename, String resourceName, String zipFilename) {
    return chilkatJNI.CkZip_AddEmbedded(swigCPtr, this, exeFilename, resourceName, zipFilename);
  }
  ...
  public boolean ExtractExe(String exePath, String dirPath) {
    return chilkatJNI.CkZip_ExtractExe(swigCPtr, this, exePath, dirPath);
  }

  public CkTask ExtractExeAsync(String exePath, String dirPath) {
    long cPtr = chilkatJNI.CkZip_ExtractExeAsync(swigCPtr, this, exePath, dirPath);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask ExtractIntoAsync(String dirPath) {
    long cPtr = chilkatJNI.CkZip_ExtractIntoAsync(swigCPtr, this, dirPath);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask ExtractMatchingAsync(String dirPath, String pattern) {
    long cPtr = chilkatJNI.CkZip_ExtractMatchingAsync(swigCPtr, this, dirPath, pattern);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask ExtractNewerAsync(String dirPath) {
    long cPtr = chilkatJNI.CkZip_ExtractNewerAsync(swigCPtr, this, dirPath);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public CkTask ExtractOneAsync(CkZipEntry entry, String dirPath) {
    long cPtr = chilkatJNI.CkZip_ExtractOneAsync(swigCPtr, this, CkZipEntry.getCPtr(entry), entry, dirPath);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
  ...
  public boolean GetExeConfigParam(String name, CkString outStr) {
    return chilkatJNI.CkZip_GetExeConfigParam(swigCPtr, this, name, CkString.getCPtr(outStr), outStr);
  }

  public String getExeConfigParam(String name) {
    return chilkatJNI.CkZip_getExeConfigParam(swigCPtr, this, name);
  }

  public String exeConfigParam(String name) {
    return chilkatJNI.CkZip_exeConfigParam(swigCPtr, this, name);
  }

  public boolean GetMaxUncompressedSize(CkString outStr) {
    return chilkatJNI.CkZip_GetMaxUncompressedSize(swigCPtr, this, CkString.getCPtr(outStr), outStr);
  }

  public String getMaxUncompressedSize() {
    return chilkatJNI.CkZip_getMaxUncompressedSize(swigCPtr, this);
  }

  public String maxUncompressedSize() {
    return chilkatJNI.CkZip_maxUncompressedSize(swigCPtr, this);
  }
  ...
  public boolean OpenEmbedded(String exeFilename, String resourceName) {
    return chilkatJNI.CkZip_OpenEmbedded(swigCPtr, this, exeFilename, resourceName);
  }
  ...
  public boolean OpenMyEmbedded(String resourceName) {
    return chilkatJNI.CkZip_OpenMyEmbedded(swigCPtr, this, resourceName);
  }
  ...
  public boolean RemoveEmbedded(String exeFilename, String resourceName) {
    return chilkatJNI.CkZip_RemoveEmbedded(swigCPtr, this, exeFilename, resourceName);
  }
  ...
  public boolean ReplaceEmbedded(String exeFilename, String resourceName, String zipFilename) {
    return chilkatJNI.CkZip_ReplaceEmbedded(swigCPtr, this, exeFilename, resourceName, zipFilename);
  }
  ...
  public void SetExeConfigParam(String paramName, String paramValue) {
    chilkatJNI.CkZip_SetExeConfigParam(swigCPtr, this, paramName, paramValue);
  }
  ...
  public boolean WriteExe(String exeFilename) {
    return chilkatJNI.CkZip_WriteExe(swigCPtr, this, exeFilename);
  }

  public CkTask WriteExeAsync(String exeFilename) {
    long cPtr = chilkatJNI.CkZip_WriteExeAsync(swigCPtr, this, exeFilename);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean WriteExe2(String exePath, String destExePath, boolean bAesEncrypt, int keyLength, String password) {
    return chilkatJNI.CkZip_WriteExe2(swigCPtr, this, exePath, destExePath, bAesEncrypt, keyLength, password);
  }

  public CkTask WriteExe2Async(String exePath, String destExePath, boolean bAesEncrypt, int keyLength, String password) {
    long cPtr = chilkatJNI.CkZip_WriteExe2Async(swigCPtr, this, exePath, destExePath, bAesEncrypt, keyLength, password);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }

  public boolean WriteExeToMemory(CkByteData outBytes) {
    return chilkatJNI.CkZip_WriteExeToMemory(swigCPtr, this, CkByteData.getCPtr(outBytes), outBytes);
  }

  public CkTask WriteExeToMemoryAsync() {
    long cPtr = chilkatJNI.CkZip_WriteExeToMemoryAsync(swigCPtr, this);
    return (cPtr == 0) ? null : new CkTask(cPtr, true);
  }
