...
public class CkCert {
  ...
  public void put_EventCallbackObject(CkBaseProgress progress) {
    chilkatJNI.CkCert_put_EventCallbackObject(swigCPtr, this, CkBaseProgress.getCPtr(progress), progress);
  }
  ...
  public boolean GetExtensionBd(String oid, CkBinData bd) {
    return chilkatJNI.CkCert_GetExtensionBd(swigCPtr, this, oid, CkBinData.getCPtr(bd), bd);
  }
  ...
  public boolean LinkPkcs11(CkPkcs11 session) {
    return chilkatJNI.CkCert_LinkPkcs11(swigCPtr, this, CkPkcs11.getCPtr(session), session);
  }
  ...
  public boolean SetCloudSigner(CkJsonObject json) {
    return chilkatJNI.CkCert_SetCloudSigner(swigCPtr, this, CkJsonObject.getCPtr(json), json);
  }
  ...
  public boolean UploadToCloud(CkJsonObject jsonIn, CkJsonObject jsonOut) {
    return chilkatJNI.CkCert_UploadToCloud(swigCPtr, this, CkJsonObject.getCPtr(jsonIn), jsonIn, CkJsonObject.getCPtr(jsonOut), jsonOut);
  }

  public CkTask UploadToCloudAsync(CkJsonObject jsonIn, CkJsonObject jsonOut) {
    long cPtr = chilkatJNI.CkCert_UploadToCloudAsync(swigCPtr, this, CkJsonObject.getCPtr(jsonIn), jsonIn, CkJsonObject.getCPtr(jsonOut), jsonOut);
