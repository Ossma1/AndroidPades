...
public class CkJsonArray {
  ...
  public boolean AddUIntAt(int index, long value) {
    return chilkatJNI.CkJsonArray_AddUIntAt(swigCPtr, this, index, value);
  }
  ...
  public boolean SetUIntAt(int index, long value) {
    return chilkatJNI.CkJsonArray_SetUIntAt(swigCPtr, this, index, value);
  }
  ...
  public long UIntAt(int index) {
    return chilkatJNI.CkJsonArray_UIntAt(swigCPtr, this, index);
  }
