...
public class CkCrypt2 {
  ...
  public boolean AesKeyUnwrapWithPadding(String kek, String wrappedKeyData, String encoding, CkString outStr) {
    return chilkatJNI.CkCrypt2_AesKeyUnwrapWithPadding(swigCPtr, this, kek, wrappedKeyData, encoding, CkString.getCPtr(outStr), outStr);
  }

  public String aesKeyUnwrapWithPadding(String kek, String wrappedKeyData, String encoding) {
    return chilkatJNI.CkCrypt2_aesKeyUnwrapWithPadding(swigCPtr, this, kek, wrappedKeyData, encoding);
  }
  ...
  public boolean AesKeyWrapWithPadding(String kek, String keyData, String encoding, CkString outStr) {
    return chilkatJNI.CkCrypt2_AesKeyWrapWithPadding(swigCPtr, this, kek, keyData, encoding, CkString.getCPtr(outStr), outStr);
  }

  public String aesKeyWrapWithPadding(String kek, String keyData, String encoding) {
    return chilkatJNI.CkCrypt2_aesKeyWrapWithPadding(swigCPtr, this, kek, keyData, encoding);
  }
