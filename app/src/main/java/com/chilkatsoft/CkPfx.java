...
public class CkPfx {
  ...
  public boolean ImportToWindows(boolean exportable, boolean userProtected, boolean machineKeyset, boolean allowOverwriteKey, boolean allowExport, String leafStore, String intermediateStore, String rootStore, String extraOptions) {
    return chilkatJNI.CkPfx_ImportToWindows(swigCPtr, this, exportable, userProtected, machineKeyset, allowOverwriteKey, allowExport, leafStore, intermediateStore, rootStore, extraOptions);
  }
