...
public class CkPrivateKey {
  ...
  public void put_EventCallbackObject(CkBaseProgress progress) {
    chilkatJNI.CkPrivateKey_put_EventCallbackObject(swigCPtr, this, CkBaseProgress.getCPtr(progress), progress);
  }
  ...
  public void get_UncommonOptions(CkString str) {
    chilkatJNI.CkPrivateKey_get_UncommonOptions(swigCPtr, this, CkString.getCPtr(str), str);
  }

  public String uncommonOptions() {
    return chilkatJNI.CkPrivateKey_uncommonOptions(swigCPtr, this);
  }

  public void put_UncommonOptions(String newVal) {
    chilkatJNI.CkPrivateKey_put_UncommonOptions(swigCPtr, this, newVal);
  }
  ...
  public boolean LoadPvk(CkByteData data, String password) {
    return chilkatJNI.CkPrivateKey_LoadPvk(swigCPtr, this, CkByteData.getCPtr(data), data, password);
  }

  public boolean LoadPvkFile(String path, String password) {
    return chilkatJNI.CkPrivateKey_LoadPvkFile(swigCPtr, this, path, password);
  }
  ...
  public boolean UploadToCloud(CkJsonObject jsonIn, CkJsonObject jsonOut) {
    return chilkatJNI.CkPrivateKey_UploadToCloud(swigCPtr, this, CkJsonObject.getCPtr(jsonIn), jsonIn, CkJsonObject.getCPtr(jsonOut), jsonOut);
  }

  public CkTask UploadToCloudAsync(CkJsonObject jsonIn, CkJsonObject jsonOut) {
    long cPtr = chilkatJNI.CkPrivateKey_UploadToCloudAsync(swigCPtr, this, CkJsonObject.getCPtr(jsonIn), jsonIn, CkJsonObject.getCPtr(jsonOut), jsonOut);
