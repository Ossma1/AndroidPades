...
public class CkSshKey {
  ...
  public boolean UsePkcs11(CkPkcs11 session, long privKeyHandle, long pubKeyHandle, String keyType) {
    return chilkatJNI.CkSshKey_UsePkcs11(swigCPtr, this, CkPkcs11.getCPtr(session), session, privKeyHandle, pubKeyHandle, keyType);
  }
