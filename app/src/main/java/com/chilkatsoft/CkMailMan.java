...
public class CkMailMan {
  ...
  public CkEmail LoadQueuedEmail(String path) {
    long cPtr = chilkatJNI.CkMailMan_LoadQueuedEmail(swigCPtr, this, path);
    return (cPtr == 0) ? null : new CkEmail(cPtr, true);
  }
  ...
  public boolean SendMimeQ(String fromAddr, String recipients, String mimeSource) {
    return chilkatJNI.CkMailMan_SendMimeQ(swigCPtr, this, fromAddr, recipients, mimeSource);
  }
